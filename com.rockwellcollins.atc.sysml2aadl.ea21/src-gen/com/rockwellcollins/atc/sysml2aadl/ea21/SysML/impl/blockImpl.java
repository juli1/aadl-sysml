 ...
 * <ul>
 *   <li>{@link com.rockwellcollins.atc.sysml2aadl.ea21.SysML.impl.blockImpl#getBase_Class <em>Base Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class blockImpl extends MinimalEObjectImpl.Container implements block {
		...
		if (base_Class != null && base_Class.eIsProxy()) {
			...
			if (base_Class != oldBase_Class) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SysMLPackage.BLOCK__BASE_CLASS, oldBase_Class, base_Class));
			}
		}
		return base_Class;
	}
	...
	public NotificationChain basicSetBase_Class(com.rockwellcollins.atc.sysml2aadl.ea21.UML.Class newBase_Class, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SysMLPackage.BLOCK__BASE_CLASS, oldBase_Class, newBase_Class);
	...
	public void setBase_Class(com.rockwellcollins.atc.sysml2aadl.ea21.UML.Class newBase_Class) {
		if (newBase_Class != base_Class) {
			...
			if (base_Class != null)
				msgs = ((InternalEObject)base_Class).eInverseRemove(this, UMLPackage.CLASS__SYSML_BLOCK, com.rockwellcollins.atc.sysml2aadl.ea21.UML.Class.class, msgs);
			if (newBase_Class != null)
				msgs = ((InternalEObject)newBase_Class).eInverseAdd(this, UMLPackage.CLASS__SYSML_BLOCK, com.rockwellcollins.atc.sysml2aadl.ea21.UML.Class.class, msgs);
			msgs = basicSetBase_Class(newBase_Class, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SysMLPackage.BLOCK__BASE_CLASS, newBase_Class, newBase_Class));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SysMLPackage.BLOCK__BASE_CLASS:
				if (base_Class != null)
					msgs = ((InternalEObject)base_Class).eInverseRemove(this, UMLPackage.CLASS__SYSML_BLOCK, com.rockwellcollins.atc.sysml2aadl.ea21.UML.Class.class, msgs);
