/**
 */
package com.rockwellcollins.atc.sysml2aadl.ea21.SysML.util;
...
public class SysMLAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.rockwellcollins.atc.sysml2aadl.ea21.SysML.block <em>block</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.rockwellcollins.atc.sysml2aadl.ea21.SysML.FlowPort <em>Flow Port</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
